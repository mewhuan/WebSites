                  ...
                  <h2 class="font-thin m-b">Discover <span class="musicbar animate inline m-l-sm" style="width:20px;height:20px">
                   ...
                   <section class="scrollable">
                          <ul class="list-group no-radius m-b-none m-t-n-xxs list-group-lg no-border">
                            ...
                            from concert_type ct,type ty,users u,concert c,follow,users u2,located l,venue v where l.vname=v.vname and l.cid=c.cid and c.cid=ct.cid and ty.subtype=ct.ctype and u2.username=poster and followee=u.username and actor=followee 
                            and follower='$username' order by posttime desc) t1 left outer join 
